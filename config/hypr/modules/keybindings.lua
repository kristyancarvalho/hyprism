...
bind(mod .. " + R", quickshell_ipc .. "toggleLauncher")
bind(mod .. " + K", quickshell_ipc .. "toggleWallpaperPicker")
bind(mod .. " + SHIFT + V", quickshell_ipc .. "toggleClipboard")
bind(mod .. " + SHIFT + N", quickshell_ipc .. "toggleNetwork")
...
bind(mod .. " + SHIFT + R", quickshell_ipc .. "toggleRecording")
