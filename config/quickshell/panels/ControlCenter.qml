    ...
    Flickable {
        ...
        Column {
            ...
            Grid { width: parent.width; columns: 2; spacing: 8
                ...
                ActionButton { theme: panel.theme; label: !controller.system.bluetooth.available ? "Bluetooth unavailable" : controller.system.bluetooth.connected ? "Bluetooth connected" : controller.system.bluetooth.powered ? "Bluetooth on" : "Bluetooth off"; icon: "ᛒ"; active: controller.system.bluetooth.powered; onClicked: controller.open("bluetooth") }
                ActionButton { theme: panel.theme; label: "Night mode"; icon: "◐"; active: controller.nightMode; onClicked: controller.toggleNightMode() }
                ActionButton { theme: panel.theme; label: "Power saver"; icon: "▱"; active: controller.powerSaver; onClicked: controller.togglePowerSaver() }
            }
            SliderRow { width: parent.width; theme: panel.theme; label: controller.system.audio.muted ? "Muted" : "Volume"; icon: "◖"; value: controller.system.audio.percent; available: controller.system.audio.available; onChanged: value => panel.setVolume(value) }
            SliderRow { width: parent.width; theme: panel.theme; label: "Microphone"; icon: "●"; value: controller.system.microphone.percent; available: controller.system.microphone.available; onChanged: value => panel.command("wpctl set-volume @DEFAULT_AUDIO_SOURCE@ " + value / 100) }
            SliderRow { width: parent.width; theme: panel.theme; label: "Brightness"; icon: "☼"; value: controller.system.brightness.percent; available: controller.system.brightness.available; onChanged: value => panel.setBrightness(value) }
